...
class CosmoModel:
    ...
    @staticmethod
    def d_comov(a: float, r: float, cosmo_model: "CosmoModel" | None = None) -> au.Quantity:
    ...
    def d_z(
        z: float | None = None,
        cosmo_model: "CosmoModel" | None = None,
        scaled: bool = False,
    ) -> au.Quantity:
    ...
    @staticmethod
    def d_z2kpc(
        distance: float | np.ndarray, cosmo_model: "CosmoModel" | None = None
    ) -> au.Quantity:
