"""
skais_mapper.utils.config module: Configuration and runtime functions
...
__all__ = ["get_run_id", "set_run_id", "parse_args", "save_config", "load_config"]
...
def parse_args(**kwargs) -> dict:
    ...
    # Global parameters
    parser.add_argument(
        "--name", type=str, default=get_run_id(), help="Name/UUID of the job."
    )
    # General arguments
